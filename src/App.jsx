...
function Terms() {
  return (
    <LegalPage seo={seoPages.terms} eyebrow="Terms" title="Terms">
      ...
      <p>
        The premium download page opens the current premium PDF meal plan.
        Access may depend on website availability and your device or browser
        settings.
      </p>
